...
public class Leaders extends Activity implements View.OnClickListener {
    ...
    private void searchQuestions() {
        ...
        connection.sendData("leaders_"+question);
    ...
    private void checkQuestion() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if(question > 10) {
                    Intent end = new Intent(Leaders.this, End.class);
