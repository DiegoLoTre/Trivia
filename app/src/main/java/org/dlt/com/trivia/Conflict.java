...
public class Conflict extends Activity implements View.OnClickListener {
    ...
    private void searchQuestions() {
        ...
        connection.sendData("conflict_"+question);
    ...
    private void checkQuestion() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if(question > 10) {
                    Intent end = new Intent(Conflict.this, End.class);
