...
public class Development extends Activity implements View.OnClickListener {
    ...
    private void searchQuestions() {
        ...
        connection.sendData("development_"+question);
    ...
    private void checkQuestion() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if(question > 10) {
                    Intent end = new Intent(Development.this, End.class);
