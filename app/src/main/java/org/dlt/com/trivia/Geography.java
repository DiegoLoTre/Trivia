...
public class Geography extends Activity implements View.OnClickListener {
    ...
    private void searchQuestions() {
        ...
        connection.sendData("geography_"+question);
    ...
    private void checkQuestion() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                if(question > 10) {
                    Intent end = new Intent(Geography.this, End.class);
